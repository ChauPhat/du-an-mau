...
public class NguoiHocDAO extends EduSysDAO<NguoiHoc, String> {
    ...
    public void insert(NguoiHoc entity) {
        ...
        JdbcHelper.update(INSERT_SQL, entity.getMaNH(), entity.getHoTen(), entity.getNgaySinh(),
                entity.getGioiTinh(), entity.getDienThoai(), entity.getEmail(), entity.getGhiChu(), entity.getMaNV(),
                entity.getNgayDK(),entity.getTrinhDo());
    }

    @Override
    public void update(NguoiHoc entity) {
        String UPDATE_SQL = "update NguoiHoc SET HoTen=?, NgaySinh=?, GioiTinh=?, DienThoai=?, Email=?, GhiChu=?, "
                + "MaNV=?, trinhdo=? WHERE MaNH=?";
        JdbcHelper.update(UPDATE_SQL, entity.getHoTen(), entity.getNgaySinh(),
                entity.getGioiTinh(), entity.getDienThoai(), entity.getEmail(), entity.getGhiChu(), entity.getMaNV(),
                entity.getTrinhDo(),entity.getMaNH());
    }
    ...
    public List<NguoiHoc> selectByKeyword(String keyword) {
        String sql = "select * from NguoiHoc where MaNH like ? or HoTen like ? or DienThoai like ? or Email like ? or MaNV like ? or trinhdo like ?";
