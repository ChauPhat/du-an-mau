...
public class QuanLyNguoiHocJDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        rdoToiLaBeDe = new javax.swing.JRadioButton();
        ...
        buttonGroup1.add(rdoToiLaBeDe);
        rdoToiLaBeDe.setText("Bê đê");
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addComponent(rdoToiLaBeDe, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE))
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(21, 21, 21)
                                .addComponent(rdoCaoDang, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(23, 23, 23)
                                .addComponent(rdoDaiHoc, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
...
//        txtNgaySinh.setText("dd-MM-yyyy");
    ...
    private javax.swing.JRadioButton rdoToiLaBeDe;
    ...
    boolean check() {
        ...
        // Kiểm tra giới tính
        if (!rdoNam.isSelected() && !rdoNu.isSelected() && !rdoToiLaBeDe.isSelected()) {
            thongBao += "Bạn chưa chọn giới tính\n";
        }
        if (!rdoCaoDang.isSelected() && !rdoDaiHoc.isSelected() && !rdoKhac.isSelected()) {
    ...
    void fillTable() {
        ...
        try {
            ...
            for (NguoiHoc nh : list) {
                ...
                String trinhdo;
                if ("Cao đẳng".equals(nh.getTrinhDo())) {
                    trinhdo = "Cao đẳng";
                } else if ("Đại học".equals(nh.getTrinhDo())) {
                    trinhdo = "Đại học";
                } else {
                    trinhdo = "Khác";
                }
                Object[] row = {nh.getMaNH(), nh.getHoTen(), gioiTinh, XDate.toString(nh.getNgaySinh(), "dd-MM-yyyy"), nh.getDienThoai(), nh.getEmail(),
                    nh.getMaNV(), XDate.toString(nh.getNgayDK(), "dd-MM-yyyy"), trinhdo
                };
                model.addRow(row);
            }
        } catch (Exception e) {
    ...
    void fillTableFind() {
        ...
        try {
            ...
            for (NguoiHoc nh : list) {
                ...
                String trinhdo;
                if (nh.getTrinhDo().equals("Cao đẳng")) {
                    trinhdo = "Cao đẳng";
                } else if (nh.getTrinhDo().equals("Đại học")) {
                    trinhdo = "Đại học";
                } else {
                    trinhdo = "Khác";
                }
