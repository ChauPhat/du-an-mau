...
public class QuanLyHocVienJDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        tblHocVien.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "TT", "Mã HV", "MÃ NH", "Họ Tên", "Điểm", "Số điện thoại"
            }
        ) {
    ...
    private void fillTableHocVien() {
        ...
        if (kh != null) {
            ...
            for (int i = 0; i < list.size(); i++) {
                ...
                String sdt = new NguoiHocDAO().selectById(hv.getMaNH()).getDienThoai();
                model.addRow(new Object[]{i + 1, hv.getMaHV(), hv.getMaNH(), hoTen, hv.getDiem(), sdt});
            }
    ...
    private void fillTableNguoiHoc() {
        ...
        for (NguoiHoc nh : list) {
            ...
            model.addRow(new Object[]{nh.getMaNH(), nh.getHoTen(), gioiTinh,
    ...
    void fillTableFind() {
        ...
        try {
            ...
            for (NguoiHoc nh : list) {
                ...
                Object[] row = {nh.getMaNH(), nh.getHoTen(), gioiTinh, XDate.toString(nh.getNgaySinh(), "dd-MM-yyyy"),
